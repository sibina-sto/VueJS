        ...
        <table>
          ...
          <tbody>
            <tr>
              <td>
                <div style="aspect-ratio: 1/1; width: 5rem; border-radius: 0.5rem; overflow: hidden;">
                  <img
                    ...
                    src="https://i.dummyjson.com/data/products/53/2.jpg" alt=""
                  >
                </div>
              </td>
              <td>
              ...
              <td><input type="number" value="2" style="width: 5rem;"></td>
              <td class="price">
                $70
              </td>
            </tr>
            <tr>
              <td>
                <div style="aspect-ratio: 1/1; width: 5rem; border-radius: 0.5rem; overflow: hidden;">
                  <img
                    style="object-fit: cover; width: 100%; height: 100%;"
                    src="https://i.dummyjson.com/data/products/81/1.jpg" alt=""
                  >
                </div>
              </td>
              <td>
              ...
              <td><input type="number" value="1" style="width: 5rem;"></td>
              <td class="price">
                $19
              </td>
            </tr>
            <!-- Add more rows for additional items here -->
          </tbody>
          <tfoot>
            <tr>
              <td colspan="3">
